 ...
 * code.
 ******************************************/
#ifndef BYTEHEXSOURCECODEINSTRUCTION_H
#define BYTEHEXSOURCECODEINSTRUCTION_H
...
class ByteHexSourceCodeInstruction : public SourceCodeInstruction
{
	public:
		ByteHexSourceCodeInstruction(
			SourceCodeLine line);
