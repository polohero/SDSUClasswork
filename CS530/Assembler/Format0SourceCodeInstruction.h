 ...
 * code.
 ******************************************/
#ifndef FORMATZEROSOURCECODEINSTRUCTION_H
#define FORMATZEROSOURCECODEINSTRUCTION_H
...
class Format0SourceCodeInstruction : public SourceCodeInstruction
{
	public:
		Format0SourceCodeInstruction(
			SourceCodeLine line,
