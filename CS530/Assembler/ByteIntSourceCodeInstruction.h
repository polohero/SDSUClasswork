 ...
 * code.
 ******************************************/
#ifndef BYTEINTSOURCECODEINSTRUCTION_H
#define BYTEINTSOURCECODEINSTRUCTION_H
...
class ByteIntSourceCodeInstruction : public SourceCodeInstruction
{
	public:
		ByteIntSourceCodeInstruction(
			SourceCodeLine line);
